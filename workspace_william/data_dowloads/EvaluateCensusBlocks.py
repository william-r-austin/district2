...
sf = shapefile.Reader("VoronoiMap11/VoronoiMap11v2.shp")
...
for current in sf.iterShapeRecords():
	...
	proposedName = currentRecord['DNAME']
...
sf2 = shapefile.Reader("CombinedData5/CombinedData5.shp")
outFile = open("district_assignments_11.csv", "w")
...
for censusBlock in sf2.iterShapeRecords():
	...
	if assignedDistrict is not None:
		finalAssigassignedDistrict = assignedDistrict.split()[2]
