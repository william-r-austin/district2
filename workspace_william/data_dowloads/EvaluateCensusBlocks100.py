...
sf = shapefile.Reader("MyGeneratedShapefiles/VoronoiMap100v1.shp")
...
for current in sf.iterShapeRecords():
	...
	proposedName = "District " + str(currentRecord['N100DNUM'])
...
outFile = open("district_assignments_100.csv", "w")
